...
import com.example.cunamas.feature.gestion.usecase.modulo.GetModulosUseCase // Puedes usar el mismo caso de uso si es compartido o uno propio de cocina
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.launch

class CocinaModulosViewModel(
    private val getModulos: GetModulosUseCase,
    val sessionManager: SessionManager,
    private val idLocal: Int // 👈 Recibido por parámetro para Koin
) : ViewModel() {
