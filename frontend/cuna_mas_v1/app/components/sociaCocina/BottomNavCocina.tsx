...
export const NAV_ITEMS = [
  ...
  },
  {
    key: 'calculadora',
    label: 'Calculadora',
    route: '/asistente/calculadora/calculadoraDosificadora',
    rutasRelacionadas: [
      '/asistente/calculadora/calculadoraDosificadora',
    ],
...
export default function BottomNavCocina({ rutaActual, insetsBottom = 0, itemsVisibles }: Props) {
  ...
  return (
    <View style={[styles.bottomNav, { minHeight: 60 + insetsBottom, paddingBottom: insetsBottom }]}>
      {itemsAMostrar.map((item) => {
        ...
        return (
          ...
          >
            ...
            />
            <Text style={[styles.navLabel, activo && styles.navLabelActivo]} maxFontSizeMultiplier={1.4}>
              {item.label}
            </Text>
          </TouchableOpacity>
        );
...
const styles = StyleSheet.create({
  ...
  navItem: { flex: 1, minWidth: 0, justifyContent: 'center', alignItems: 'center', paddingVertical: 6 },
  navLabel: { fontSize: 11, marginTop: 2, color: '#757575', textAlign: 'center', flexShrink: 1 },
