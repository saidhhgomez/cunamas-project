...
export default function BottomNavCocina({ rutaActual, insetsBottom = 0, itemsVisibles }: Props) {
  ...
  return (
    <View style={[styles.bottomNav, { minHeight: 68 + insetsBottom, paddingBottom: insetsBottom }]}>
...
const styles = StyleSheet.create({
  ...
  navItem: { flex: 1, minWidth: 0, justifyContent: 'center', alignItems: 'center', paddingVertical: 8 },
  navLabel: { fontSize: 11, marginTop: 4, color: '#757575', textAlign: 'center', flexShrink: 1 },
