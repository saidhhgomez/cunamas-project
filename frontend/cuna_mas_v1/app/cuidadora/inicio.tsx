...
export default function InicioCuidadora() {
  ...
  const manejarGuardarDireccion = async () => {
    ...
    try {
      ...
      mostrarError("Error", "No se pudo guardar la ubicación");
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <View style={styles.textContainer}>
                  <Text style={[styles.localName, { fontSize: esPantallaGrande ? 19 : 15 }]}>
                    {item.localNombre} 
                  </Text>
...
const styles = StyleSheet.create({
  ...
  localItem: {
    width: '100%', minHeight: 76, borderWidth: 2, borderColor: '#006080', borderRadius: 16,
    flexDirection: 'row', alignItems: 'flex-start', paddingHorizontal: 16, paddingVertical: 14, marginBottom: 14,
  ...
  textContainer: { marginLeft: 14, flex: 1, minWidth: 0, justifyContent: 'center' },
  localName: { fontWeight: '800', color: '#1E293B', textTransform: 'uppercase', flexShrink: 1, lineHeight: 22 },
  localSubtitle: { fontSize: 12, color: '#64748B', marginTop: 4, flexShrink: 1, lineHeight: 18 },
