...
import { ChevronDown, ChevronUp, ArrowLeft, Eye, EyeOff, Check, X as XIcon } from 'lucide-react-native';
...
export default function RegistroScreen() {
  ...
  const [modalTipo, setModalTipo] = useState<TipoModalMensaje>('exito');
  const [modalTitulo, setModalTitulo] = useState('');
  const [modalMensaje, setModalMensaje] = useState('');

  const abrirModal = (tipo: TipoModalMensaje, titulo: string, mensaje: string) => {
    setModalTipo(tipo);
