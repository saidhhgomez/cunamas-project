...
export default function LoginScreen() {
  ...
  const tamañoTextoRegistro = esPantallaGrande ? 16 : 14;
      ...
      >
        ...
        >
          ...
          <View style={styles.registerContainer}>
            <Text style={[styles.registerText, { fontSize: tamañoTextoRegistro }]}>¿No estás registrado? </Text>
            <Link href="/auth/register" asChild>
              <TouchableOpacity activeOpacity={0.7} focusable={true}>
                <Text style={[styles.registerLink, { fontSize: tamañoTextoRegistro }]}>Regístrate Aquí</Text>
              </TouchableOpacity>
            </Link>
          </View>
        </ScrollView>
