    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle} allowFontScaling={false}>Nuevo Centro Alimentario</Text>
          <View style={{ width: 40 }} />
        </View>
        ...
        <View style={{ flex: 1, position: 'relative' }}>
          ...
          >
            ...
            <TextInput
              ...
              placeholder="Ej. Comedor Cartagena"
            ...
            <TextInput
              style={[styles.input, styles.inputFixedText, styles.inputLongText]}
