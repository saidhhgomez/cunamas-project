...
export default function AgregarLocal() {
  ...
  const handleGuardarLocal = async () => {
    ...
    try {
      ...
      const idDireccionGenerado = Number(resDireccion?.idGenerado);
      ...
      console.log('[Locales] Paso 2 - usando idDireccion:', idDireccionGenerado);
    ...
    >
      <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle} allowFontScaling={false}>Nuevo Local Infantil</Text>
          <View style={{ width: 40 }} />
        </View>
        ...
        <View style={{ flex: 1, position: 'relative' }}>
          ...
          >
            <Text style={styles.sectionTitle} allowFontScaling={true}>Detalles del Local</Text>

            <View style={styles.labelRow}>
              <Text style={styles.label} allowFontScaling={true}>Nombre del Local</Text>
              <Text style={styles.requiredMark} allowFontScaling={true}>*</Text>
            </View>
            <TextInput
              style={[styles.input, styles.inputFixedText, styles.inputLongText, styles.inputWide]}
            ...
            <Text style={styles.sectionTitle} allowFontScaling={true}>Ubicación y Geografía</Text>

            <View style={styles.labelRow}>
              <Text style={styles.label} allowFontScaling={true}>Buscar Distrito</Text>
              <Text style={styles.requiredMark} allowFontScaling={true}>*</Text>
            </View>
            <View 
            ...
            >
              <View style={styles.searchSection}>
                <TextInput
                  style={[styles.input, styles.inputFixedText, styles.inputWide, { marginBottom: 0, flex: 1, paddingRight: 45 }]}
                  placeholder="Escriba un distrito..."
                  placeholderTextColor="#94A3B8"
                  allowFontScaling={false}
                  maxFontSizeMultiplier={1}
                  numberOfLines={1}
            ...
            <View style={styles.labelRow}>
              <Text style={styles.label} allowFontScaling={true}>Dirección Exacta</Text>
              <Text style={styles.requiredMark} allowFontScaling={true}>*</Text>
            </View>
            <TextInput
              style={[styles.input, styles.inputFixedText, styles.inputLongText, styles.inputWide]}
            ...
            >
              {isSaving ? (
                ...
                <Text style={[styles.submitButtonText, botonDeshabilitado && { color: '#94A3B8' }]} allowFontScaling={false}>Registrar Local</Text>
              )}
            </TouchableOpacity>
          ...
          {mostrarSugerencias && !isSaving && (
            <View 
              ...
              onTouchCancel={() => setScrollPrincipalHabilitado(true)}
            >
              <FlatList
                data={listaDistritos}
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    ...
                    <Text style={styles.suggestionText} numberOfLines={1} allowFontScaling={false}>
                      {item.distrito}, {item.provincia} - <Text style={styles.ubigeoText} allowFontScaling={false}>Ubigeo {item.ubigeo}</Text>
                    </Text>
                  </TouchableOpacity>
                )}
              />
        ...
        {isSaving && (
          <View style={styles.blockingOverlay}>
            <View style={styles.loadingBox}>
              ...
              <Text style={styles.blockingText} allowFontScaling={false}>Registrando local...</Text>
              <Text style={styles.blockingSubtext} allowFontScaling={false}>Por favor, no cierre la aplicación</Text>
            </View>
          </View>
        )}
      </View>
